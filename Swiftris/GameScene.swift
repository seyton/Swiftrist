...
class GameScene: SKScene {
    ...
    var tick:(() -> ())?
    var tickLenthMillis = TickLengthLevelOne
    var lastTick:NSDate?
    ...
    override init(size: CGSize) {
        ...
        let gameBoard = SKSpriteNode(texture: gameBoardTexture, size: CGSizeMake(BlockSize * CGFloat(NumColumns),
        ...
        runAction(SKAction.repeatAction(SKAction.playSoundFileNamed("theme.mp3", waitForCompletion: true)))
